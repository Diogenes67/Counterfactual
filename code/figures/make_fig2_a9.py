...
kx, ky = xy(OK)
ax.scatter(kx, ky, s=34, marker='D', color='#CC79A7', edgecolor='white', lw=0.6, zorder=4,
           label='Oracle edit (toward retrained)')
...
ax.text(-7.05, 0.52, 'NF4: content returns,\nsignature erased', fontsize=6.8, color='#B02A2A', ha='left')
ax.annotate('oracle stalls\nhalfway', xy=(np.mean(kx), np.mean(ky)), xytext=(np.mean(kx) - 0.15, 0.24),
            fontsize=6.8, color='#CC79A7', ha='center',
            arrowprops=dict(arrowstyle='-', color='#CC79A7', lw=0.7, shrinkA=2, shrinkB=4))
...
plt.savefig('/tmp/a5/fig2_a9.png', dpi=300)
plt.savefig('/tmp/a5/fig2_a9.pdf')
print('saved fig2_a9')
